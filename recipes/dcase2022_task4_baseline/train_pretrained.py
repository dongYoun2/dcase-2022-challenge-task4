...
def single_run(
    config, log_dir, gpus, checkpoint_resume=None, test_state_dict=None, fast_dev_run=False, evaluation=False
):
    """
    ...
    if not evaluation:
        ...
        devtest_embeddings = (
            ...
            if config["pretrained"]["e2e"]
                ...
                config["pretrained"]["extracted_embeddings_dir"], config["pretrained"]["model"], "devtest.hdf5"
            )
        )
        ...
        devtest_dataset = UnlabeledSet(
            config["data"]["eval_folder"], encoder, pad_to=None, return_filename=True, feats_pipeline=feature_extraction
        )
    ...
    if test_state_dict is None:
        ...
        synth_set_embeddings = (
            ...
            if config["pretrained"]["e2e"]
                ...
                config["pretrained"]["extracted_embeddings_dir"], config["pretrained"]["model"], "synth_train.hdf5"
            )
        )
        ...
        weak_set_embeddings = (
            ...
            if config["pretrained"]["e2e"]
                ...
                config["pretrained"]["extracted_embeddings_dir"], config["pretrained"]["model"], "weak_train.hdf5"
            )
        )
        weak_set = WeakSet(
        ...
        unlabeled_set_embeddings = (
            ...
            if config["pretrained"]["e2e"]
                ...
                config["pretrained"]["extracted_embeddings_dir"], config["pretrained"]["model"], "unlabeled_train.hdf5"
            )
        )
        ...
        synth_val_embeddings = (
            ...
            if config["pretrained"]["e2e"]
                ...
                config["pretrained"]["extracted_embeddings_dir"], config["pretrained"]["model"], "synth_val.hdf5"
            )
        )
        ...
        weak_val_embeddings = (
            ...
            if config["pretrained"]["e2e"]
                ...
                config["pretrained"]["extracted_embeddings_dir"], config["pretrained"]["model"], "weak_val.hdf5"
            )
        )
        weak_val = WeakSet(
            config["data"]["weak_folder"],
